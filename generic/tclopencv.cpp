...
Opencv_Init(Tcl_Interp *interp)
{
    ...
    Tcl_CreateObjCommand(interp, "::" NS "::countNonZero",
    ...
    Tcl_CreateObjCommand(interp, "::" NS "::solveCubic",
    ...
    Tcl_CreateObjCommand(interp, "::" NS "::imdecode",
    ...
    Tcl_CreateObjCommand(interp, "::" NS "::HuMoments",
    ...
    Tcl_CreateObjCommand(interp, "::" NS "::getDerivKernels",
    ...
    Tcl_CreateObjCommand(interp, "::" NS "::fitEllipse",
    ...
    Tcl_CreateObjCommand(interp, "::" NS "::ml::DTrees",
