...
MODULE_SCOPE int mat_findNonZero(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
...
MODULE_SCOPE int mat_insertChannel(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
...
MODULE_SCOPE int mat_max(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
MODULE_SCOPE int mat_meanStdDev(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
MODULE_SCOPE int mat_min(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
...
MODULE_SCOPE int mat_repeat(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
...
MODULE_SCOPE int buildPyramid(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
...
MODULE_SCOPE int approxPolyDP(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
...
MODULE_SCOPE int matchShapes(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
...
MODULE_SCOPE int getFontScaleFromHeight(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
MODULE_SCOPE int getTextSize(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
...
MODULE_SCOPE int setWindowTitle(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
...
MODULE_SCOPE int estimateAffinePartial2D(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
MODULE_SCOPE int estimateAffine3D(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
...
#endif
#if CV_VERSION_GREATER_OR_EQUAL(4, 8, 0)
MODULE_SCOPE int BarcodeDetector(void *cd, Tcl_Interp *interp, int objc, Tcl_Obj *const*objv);
#endif
#endif
...
#endif
#if CV_VERSION_GREATER_OR_EQUAL(4, 8, 0)
    Tcl_Command cmd_barcodeDetector;
#endif
#endif
