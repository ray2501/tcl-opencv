...
PKG_SOURCES	=  tclopencv.cpp tcore.cpp timgproc.cpp timgcodecs.cpp tvideoio.cpp thighgui.cpp tvideo.cpp tfeatures2d.cpp tcalib3d.cpp tphoto.cpp tstitcher.cpp tobjdetect.cpp tdnn.cpp tml.cpp
PKG_OBJECTS	=  tclopencv.o tcore.o timgproc.o timgcodecs.o tvideoio.o thighgui.o tvideo.o tfeatures2d.o tcalib3d.o tphoto.o tstitcher.o tobjdetect.o tdnn.o tml.o
...
PKG_LIB_FILE	= libopencv0.8.so
PKG_LIB_FILE8	= libopencv0.8.so
PKG_LIB_FILE9	= libtcl9opencv0.8.so
PKG_STUB_LIB_FILE = libopencvstub0.8.a
...
top_builddir	= /home/danilo/Public/tcl-opencv
...
PKG_CFLAGS	=  -DTCL_USE_OPENCV4=1  -DTCL_USE_SIFT=1
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"opencv\" -DPACKAGE_TARNAME=\"opencv\" -DPACKAGE_VERSION=\"0.8\" -DPACKAGE_STRING=\"opencv\ 0.8\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_opencv=/\*\*/ -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"opencv\" -DPACKAGE_TARNAME=\"opencv\" -DPACKAGE_VERSION=\"0.8\" -DPACKAGE_STRING=\"opencv\ 0.8\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_opencv=/\*\*/ -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 $(PKG_CFLAGS)
