...
PKG_LIB_FILE	= libopencv0.10.so
PKG_LIB_FILE8	= libopencv0.10.so
PKG_LIB_FILE9	= libtcl9opencv0.10.so
PKG_STUB_LIB_FILE = libopencvstub0.10.a
...
PKG_CFLAGS	=  -std=c++11 -DTCL_USE_OPENCV4=1  -DTCL_USE_SIFT=1
