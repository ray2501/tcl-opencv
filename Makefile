...
PKG_SOURCES	=  tclopencv.cpp tcore.cpp timgproc.cpp timgcodecs.cpp tvideoio.cpp thighgui.cpp tvideo.cpp tfeatures2d.cpp tcalib3d.cpp tphoto.cpp tstitcher.cpp tobjdetect.cpp tdnn.cpp
PKG_OBJECTS	=  tclopencv.o tcore.o timgproc.o timgcodecs.o tvideoio.o thighgui.o tvideo.o tfeatures2d.o tcalib3d.o tphoto.o tstitcher.o tobjdetect.o tdnn.o
